...
Grammar grammar = {
    {
        ...
        {"binary_operator", 1, {"Eg"}},
        {"binary_operator", 1, {"Ne"}},
        {"binary_operator", 1, {"Le"}},
        {"binary_operator", 1, {"Ge"}},
        {"binary_operator", 1, {"++"}},
        {"binary_operator", 1, {"--"}},
        {"binary_operator", 1, {"**"}},
        ...
        {"tokenEQUAL", 1, {"Eg"}},
        {"tokenNOTEQUAL", 1, {"Ne"}},
        {"tokenLESSOREQUAL", 1, {"Ge"}},
        {"tokenGREATEROREQUAL", 1, {"Le"}},
        {"tokenPLUS", 1, {"++"}},
        {"tokenMINUS", 1, {"-_"}},
        {"tokenMUL", 1, {"**"}},
        {"tokenDIV", 1, {"DIV"}},
...
bool cykAlgorithmImplementation(struct LexemInfo* lexemInfoTable, Grammar* grammar, int maxErrorToViewCount) {
