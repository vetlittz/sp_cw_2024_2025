...
unsigned char* noMake(struct LexemInfo** lastLexemInfoInTable, unsigned char* currBytePtr) {
	if (!strncmp((*lastLexemInfoInTable)->lexemStr, "Program", MAX_LEXEM_SIZE)
		|| !strncmp((*lastLexemInfoInTable)->lexemStr, "Var", MAX_LEXEM_SIZE)
		...
		|| !strncmp((*lastLexemInfoInTable)->lexemStr, "Int_4", MAX_LEXEM_SIZE)
		|| !strncmp((*lastLexemInfoInTable)->lexemStr, ",", MAX_LEXEM_SIZE)
		|| !strncmp((*lastLexemInfoInTable)->lexemStr, "Finish", MAX_LEXEM_SIZE)
		) {
